<?php
	...
	if(!empty($_GET['act']) && $_GET['act'] == 'edit'){
		if(!empty($_POST)){
			...
			$q = mysqli_query($conn, "update laporan SET nama_barang='$nama_barang',harga='$harga',jumlah='$jumlah',total='$total' where id_pengeluaran=$_GET[id]") or die(mysqli_error());
			if($q){ alert("Success"); redir("input_pengeluaran.php"); }
		}
	}
			...
			if(!empty($_GET)){
				...
				?>
					...
					<form action="" method="post" enctype="multipart/form-data">
						...
						<label>Tanggal Dikeluarkannya Barang</label><br>
